...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    saveCustomer: function saveCustomer() {
      ...
      this.loading = true;
      axios.post("customers", this.customer).then(function _callee(res) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.snackbar = true;
                _context.next = 4;
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_this.$store.dispatch("getAllcustomers"));

              case 4:
                if (!_this.$route.params.id) {
                  setTimeout(function () {
                    window.location.hash = "#/customer/".concat(res.data.id);
                  }, 1000);
                }
                      ...
                      _c(
                        ...
                        [
                          _c("v-autocomplete", {
                            ...
                            model: {
                              value: _vm.customer.oil_brand_id,
                              callback: function($$v) {
                                _vm.$set(_vm.customer, "oil_brand_id", $$v)
                              },
                              expression: "customer.oil_brand_id"
                            }
                          })
                        ],
                        1
