            ...
            <v-col>
                <v-card class="ma-5" shaped outlined :loading="loading">
                  ...
                  <v-card-title>
                    ...
                    <delete-customer-dialog :user="editedItem" :deleteDialog="deleteDialog" @userDeleted="getcustomers(); snackbar = true;" @closeDialog="deleteDialog = false" />
                    <edit-customer-dialog :user="editedItem" :dialog="dialog" />
